...
from pyneuractiv import version as na_version
...
project = u'PyNeurActiv'
copyright = u'2017, SENeC'
...
htmlhelp_basename = 'PyNeurActivdoc'
...
latex_documents = [
  (master_doc, 'PyNeuroActiv.tex', u'PyNeuroActiv Documentation',
...
texinfo_documents = [
  (master_doc, 'PyNeuroActiv', u'PyNeuroActiv Documentation',
   author, 'PyNeuroActiv', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'nngt': ('http://nngt.readthedocs.io/en/latest/index.html', None)
}
