...
''')
    ...
    def __init__(self, di_prop, ignore_errors=False, verbose=True):
        '''
        Create an object capable of computing the properties for a population
        of neurons with given parameters. Compute all the dimensionless values
        ...
        ignore_errors : bool, optional (default: False)
            If ``True``, do not raise an error if an invalid result is obtained
            but returns NaN instead.
        verbose : bool, optional (defalut: True)
            Whether the warnings should be displayed.
        ...
        ----
            ...
            * ``"model"``: NEST model name, e.g. "aeif_psc_alpha"
            * a ``"weight"`` entry giving the synaptic strength in pA
            * an ``"avg_deg"`` entry giving the average number of neighbours
            * a ``"delay"`` entry for the synaptic delay
        '''
        self._prop = di_prop
    ...
    def time_evolution(self, model="alpha", num_bursts=3, steps=1000,
        ...
        ----------
        model : :obj:`str`, optional, (default: "alpha")
            Model to use for the synapses among "dirac", "continuous" and
            "alpha". num_bursts (int, optional, default: 3): Number of bursts
            to model.
        ...
        Returns
        -------
        ts, Vs, ws, stimes : numpy arrays
            Time, voltage, adaptation variables, and spike times.
        '''
    ...
    def ISI(self, w, model="alpha", I=None, approx=False, adim=False):
        ...
        I : double, optional, (default: None)
            Value of the input current (required for "continuous" model only).
        adim : bool, optional, (default: False)
    ...
    def IBI(self, w_max=None, model="alpha", adim=False):
        ...
        w_max : double, optional, (default: None)
            ...
            (given by the self-coherent equation). If ``None``, will be
            computed using the model given by the `model` parameter.
        model : obj:`str`, optional, (default: "alpha")
